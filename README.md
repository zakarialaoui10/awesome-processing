...
- # Contributions
  ...
  - ## Animation
    ...
    - []() by []()
  - ## Geometry
    - [Computational Geometry](http://thecloudlab.org/processing/library.html) by []()
    - [Culebra Behavior Library for Processing](http://www.complicitmatter.com/culebra-java/) by []()
    - [Dashed Lines](https://github.com/garciadelcastillo/-dashed-lines-for-processing-) by []()
    - [Geomerative](http://www.ricardmarxer.com/geomerative) by []()
    - [Nurbs](https://arnoudvanderleer.github.io/processing-nurbs/) by []()
    - [OCT](https://github.com/thwegene/OCT) by []()
    - [Squarify](https://github.com/agatheblues/squarify) by []()
    - [handy](https://www.gicentre.net/software/) by []()
    - [proscene](http://otrolado.info/) by []()
  - ## Math
